...
class ScooterTestApp:
    def __init__(self, master):
        self.master = master
        self.master.title("Scooter Driving Written Test")  # Updated heading
    ...
    def create_widgets(self):
        # Heading
        heading_label = tk.Label(self.heading_frame, text="Scooter Driving Written Exam", font=("Arial", 18, "bold"))
